...
import 'package:smart_home/database_helper.dart'; // Yeni import
import 'package:smart_home/features/home/controller/controller.dart'; // Yeni import
import 'dart:async';
...
class _DetailsScreenState extends State<DetailsScreen> {
  ...
  void _fetchData() async {
    ...
    if (latestData.isNotEmpty) {
      setState(() {
        widget.model.value = latestData['temperature'] ?? 0.0;
        widget.model.model1.value = latestData['sound'].toString();
        widget.model.model2.value = latestData['brightness'].toString();
        widget.model.model3.value = latestData['user_count'].toString();
      });
